...
insert into Initiative (Title, Description, Status, CreationDate, Field, KeyWords, Users_ID, Tag_ID)
	values ('Construir Piscina', 'Sería genial tener una piscina para los estudiantes y que así pueda haber un equipo de natación en la escuela, así mismo para poder desestresarse de la carga de trabajos', 'En revision', TO_DATE('31/10/2018', 'DD/MM/YYYY'), 'Deporte', '{"piscina","equipo natacion","natacion"}', 5, 10);
